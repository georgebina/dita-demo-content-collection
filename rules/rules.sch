...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   ...
   <pattern is-a="avoidAttributeInElement"
            see="http://georgebina.github.io/dita-demo-content-collection/styleguide/topics/images.html">
   ...
   <pattern is-a="avoidEndFragment"
            see="http://georgebina.github.io/dita-demo-content-collection/styleguide/topics/lists.html">
   ...
   <pattern is-a="restrictNumberOfChildren"
      ...
      <param name="message" value="Lists should contain between 2 and 8 items!"/>
   </pattern>
   <!--Generated from topics/metadata.dita.
    -->
   <pattern is-a="avoidWordInElement"
            see="http://georgebina.github.io/dita-demo-content-collection/styleguide/topics/metadata.html">
      <param name="element" value="indexterm"/>
      <param name="word" value="thunderbird"/>
      <param name="message" value="Do not use ''thunderbird'' in index terms!"/>
   </pattern>
   <!--Generated from topics/metadata.dita.
    -->
   ...
   <pattern is-a="restrictCharacters"
      ...
      <param name="message"
             value="Short description should be used on twitter so we need to keep them less than 140&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;characters."/>
   </pattern>
